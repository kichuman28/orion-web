    ...
    <div className="min-h-screen bg-orion-lightBg">
        ...
        <div className="max-w-7xl mx-auto py-4 px-4 sm:px-6 lg:px-8 flex justify-between items-center">
          ...
          <div className="flex items-center space-x-4">
            <div className="text-orion-gray">
              {currentUser?.email} <span className="ml-2 px-2 py-1 bg-blue-100 text-blue-800 text-xs font-medium rounded-full">Committee Member</span>
            </div>
            <button
      ...
      <main>
        <div className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
          ...
          <div className="bg-white shadow overflow-hidden sm:rounded-lg mb-6">
            <div className="px-4 py-5 sm:px-6">
              <h3 className="text-lg font-medium text-orion-darkGray">Papers Pending Review</h3>
              <p className="mt-1 max-w-2xl text-sm text-orion-gray">
                Review new paper submissions.
              </p>
            </div>
            <div className="border-t border-gray-200">
              <div className="px-4 py-5 sm:p-6">
                <div className="text-center py-10">
                  <p className="text-orion-gray">No papers are currently waiting for review.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white shadow overflow-hidden sm:rounded-lg">
            <div className="px-4 py-5 sm:px-6">
              <h3 className="text-lg font-medium text-orion-darkGray">Your Reviewed Papers</h3>
              <p className="mt-1 max-w-2xl text-sm text-orion-gray">
                Papers you have previously reviewed.
              </p>
            </div>
            <div className="border-t border-gray-200">
              <div className="px-4 py-5 sm:p-6">
                <div className="text-center py-10">
                  <p className="text-orion-gray">You haven't reviewed any papers yet.</p>
                </div>
              </div>
            </div>
          </div>
