      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-white py-8 px-4 shadow-lg sm:rounded-lg sm:px-10">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            <div>
              <label htmlFor="fullName" className="block text-sm font-medium text-orion-darkGray">
                Full Name
              </label>
              <div className="mt-1">
                <input
            ...
            <div>
              <label htmlFor="confirmPassword" className="block text-sm font-medium text-orion-darkGray">
                Confirm Password
              </label>
              <div className="mt-1">
                <input
